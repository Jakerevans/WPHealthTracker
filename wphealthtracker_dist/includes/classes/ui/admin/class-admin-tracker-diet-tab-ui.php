<?php
/**
 * Class WPHealthTracker_Diet_Tab - class-admin-tracker-diet-tab-ui.php
 *
 * @author   Jake Evans
 * @category Admin
...
if ( ! class_exists( 'WPHEALTHTRACKER_Diet_Tab', false ) ) :
	/**
	 * WPHEALTHTRACKER_Diet_Tab.
	 */
	class WPHEALTHTRACKER_Diet_Tab {

		public function __construct() {
			require_once WPHEALTHTRACKER_CLASSES_UI_DISPLAY_DIR . 'class-ui-display-template.php';
			require_once WPHEALTHTRACKER_CLASSES_UI_DISPLAY_DIR . 'class-wphealthtracker-diet-form.php';
			// Instantiate the class
			$this->template = new WPHEALTHTRACKER_UI_Display_Template();
			$this->form     = new WPHEALTHTRACKER_Diet_Form();
...
// Instantiate the class
$am = new WPHEALTHTRACKER_Diet_Tab();
