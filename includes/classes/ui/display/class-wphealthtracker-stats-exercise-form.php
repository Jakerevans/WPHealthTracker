<?php
/**
 * Class WPHEALTHTRACKER_Stats_Exercise_Form - class-wphealthtracker-stats-exercise-form.php
 *
 * @author   Jake Evans
 * @category Display
...
if ( ! class_exists( 'WPHEALTHTRACKER_Stats_Exercise_Form', false ) ) :
	/**
	 * WPHEALTHTRACKER_Stats_Exercise_Form.
	 */
	class WPHEALTHTRACKER_Stats_Exercise_Form {
		...
		public function __construct() {
			...
			// Output final HTML.
			$this->output_create_exercise_stats_form();
		...
		public function wphealthtracker_output_all_saved_users() {
			...
			if ( null !== $this->allusers ) {
				...
				$this->userstring = '<select autocomplete="off" class="wphealthtracker-user-dropdown-select" id="wphealthtracker-user-dropdown-select-exercise-stats" data-select-tab="exercise"><option selected default disabled>' . $this->trans->common_trans_16 . '</option>';
		 ...
		 */
		public function output_create_exercise_stats_form() {
			$string1              = '<div class="wphealthtracker-select-user-container">	
						...
						<div class="wphealthtracker-stats-actual-top-div-d3 wphealthtracker-stats-actual-exercise-top-div" id="wphealthtracker-stats-inner-d3-1">
						...
						<div class="wphealthtracker-stats-actual-top-div-d3 wphealthtracker-stats-actual-exercise-top-div" id="wphealthtracker-stats-inner-d3-2">
						...
						<div class="wphealthtracker-stats-actual-top-div-d3 wphealthtracker-stats-actual-exercise-top-div" id="wphealthtracker-stats-inner-d3-3">
