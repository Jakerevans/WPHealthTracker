<?php
/**
 * Class WPHEALTHTRACKER_Stats_Diet_Form - class-wphealthtracker-stats-diet-form.php
 *
 * @author   Jake Evans
 * @category Display
...
if ( ! class_exists( 'WPHEALTHTRACKER_Stats_Diet_Form', false ) ) :
	/**
	 * WPHEALTHTRACKER_Stats_Diet_Form.
	 */
	class WPHEALTHTRACKER_Stats_Diet_Form {
		...
		public function __construct() {
			...
			// Output final HTML.
			$this->output_create_diet_stats_form();
		...
		public function wphealthtracker_output_all_saved_users() {
			...
			if ( null !== $this->allusers ) {
				...
				$this->userstring = '<select autocomplete="off" class="wphealthtracker-user-dropdown-select" id="wphealthtracker-user-dropdown-select-diet-stats" data-select-tab="diet"><option selected default disabled>' . $this->trans->common_trans_16 . '</option>';
		 ...
		 */
		public function output_create_diet_stats_form() {
