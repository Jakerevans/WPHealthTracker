...
jQuery( document ).ready( function( $ ) {
	...
	/* BEGINNING SECTION TO CALL ALL FUNCTIONS IN FILE... */
		...
		// For displaying the Diet Stats JS.
	...
	function wphealthtrackerJreGrabUserDataForDietD3() {
		...
		//$( document ).on( 'change', '.wphealthtracker-stats-actual-diet-top-div #wphealthtracker-user-dropdown-select-diet-stats', function( event ) {
			...
			$( '.wphealthtracker-stats-actual-diet-top-div .wphealthtracker-stats-actual-top-div, .wphealthtracker-stats-actual-diet-top-div .wphealthtracker-stats-actual-top-div-d3' ).animate({
				height: '0px',
				opacity: 0
			}, {
				duration: 1000,
				complete: function() {
					...
					$( '.wphealthtracker-stats-actual-diet-top-div .wphealthtracker-d3-chart-title-div' ).empty();
					$( '.wphealthtracker-stats-actual-diet-top-div .wphealthtracker-stats-actual-top-div-inner-right' ).empty();
					$( '.wphealthtracker-stats-actual-diet-top-div .wphealthtracker-stats-actual-top-div-inner-left' ).empty();

					// Turn the D3 chart spinners back on
					$( '.wphealthtracker-stats-actual-diet-top-div .wphealthtracker-spinner-primary-d3-await' ).css({'opacity': '1'});
				}
			});

			// Animate the spinner
			$( '.wphealthtracker-stats-actual-diet-top-div #wphealthtracker-spinner-1' ).animate({'opacity': '1'});
			...
			$.ajax({
				...
				success: function( response ) {
					...
					$( '.wphealthtracker-stats-actual-diet-top-div #wphealthtracker-d3-chart-title-div-1-1' ).append( titleHtmlOne );
					$( '.wphealthtracker-stats-actual-diet-top-div #wphealthtracker-d3-chart-title-div-1-2' ).append( titleHtmlTwo );
					$( '.wphealthtracker-stats-actual-diet-top-div #wphealthtracker-d3-chart-title-div-1-3' ).append( titleHtmlThree );
					...
					if ( -1 !== d3One.indexOf( 'wphealthtracker-no-saved-data-div' ) ) {
						...
						// Hide the spinner
						$( '.wphealthtracker-stats-actual-diet-top-div #wphealthtracker-spinner-d3-await-1' ).animate({'opacity': '0'});
						$( '.wphealthtracker-stats-actual-diet-top-div #wphealthtracker-stats-actual-inner-d3-1-1' ).css({'bottom': '-18px'});
						$( '.wphealthtracker-stats-actual-diet-top-div #wphealthtracker-stats-actual-inner-d3-1-1' ).append( d3One );
					} else {

						// Append any HTML that may be needed for the creation of the charts
						$( '.wphealthtracker-stats-actual-diet-top-div #wphealthtracker-stats-actual-inner-d3-1-1' ).append( '<label id="wphealthtracker-d3chart-sort-fooditems"><input type="checkbox"> Sort values</label><div class="wphealthtracker-d3chart-readout-fooditems"><p><span id="wphealthtracker-d3chart-tooltip-fooditems-item"></span><span id="wphealthtracker-d3chart-tooltip-fooditems-category"></span></p><div id="wphealthtracker-d3chart-tooltip-fooditems-number"></div></div><div class="wphealthtracker-chart-hover-message" id="wphealthtracker-chart-hover-message-fooditem">' + wphealthtrackerPhpVariables.d3trans48 + '</div>' );
					...
					if ( -1 !== d3Two.indexOf( 'wphealthtracker-no-saved-data-div' ) ) {
						...
						$( '.wphealthtracker-stats-actual-diet-top-div #wphealthtracker-spinner-d3-await-2' ).animate({'opacity': '0'});
						$( '.wphealthtracker-stats-actual-diet-top-div #wphealthtracker-stats-actual-inner-d3-1-2' ).append( d3Two );

						// Modify the CSS of the right-side container to match the height of the left - a one-off modification specific to this chart
						$( '.wphealthtracker-stats-actual-diet-top-div #wphealthtracker-stats-inner-d3-2 #wphealthtracker-stats-actual-inner-d3-2-2' ).css({'top': '0px'});
					} else {
						$( '.wphealthtracker-stats-actual-diet-top-div #wphealthtracker-stats-actual-inner-d3-1-2' ).append( '<div id="wphealthtracker-energy-chart-select-div"></div><div id="wphealthtracker-d3chart-legendContainer-energy" class="wphealthtracker-d3chart-legendContainer"><svg id="wphealthtracker-d3chart-legend-energy"></svg></div><div class="wphealthtracker-chart-hover-message" id="wphealthtracker-chart-hover-message-energy">' + wphealthtrackerPhpVariables.d3trans48 + '</div>' );
					...
					if ( -1 !== d3Three.indexOf( 'wphealthtracker-no-saved-data-div' ) ) {
						...
						// Hide the the spinner
						$( '.wphealthtracker-stats-actual-diet-top-div #wphealthtracker-spinner-d3-await-3' ).animate({'opacity': '0'});
						$( '.wphealthtracker-stats-actual-diet-top-div #wphealthtracker-stats-actual-inner-d3-1-3' ).append( d3Three );
					} else {

						// Append any HTML that may be needed for the creation of the charts
						$( '.wphealthtracker-stats-actual-diet-top-div #wphealthtracker-stats-actual-inner-d3-1-3' ).append( '<div id="wphealthtracker-d3chart-legendContainer-macro" class="wphealthtracker-d3chart-legendContainer"></div><div class="wphealthtracker-chart-hover-message" id="wphealthtracker-chart-hover-message-macro">' + wphealthtrackerPhpVariables.d3trans48 + '</div>' );
					...
					d3OneContainer = $( '.wphealthtracker-stats-actual-diet-top-div #wphealthtracker-stats-inner-d3-1' );
					...
					d3OneContainer.stop().animate({
						...
						duration: 1000,
						complete: function() {
							$( '.wphealthtracker-stats-actual-diet-top-div #wphealthtracker-stats-actual-inner-d3-2-1' ).append( statsHtmlOne );
							$( '.wphealthtracker-stats-actual-diet-top-div #wphealthtracker-d3-chart-title-div-1-1' ).animate({'opacity': 1}, 2000 );
							d3OneContainer.css({'height': 'auto'});
						}
					});

					// For animating the container's height, from 0 to auto
					d3TwoContainer = $( '.wphealthtracker-stats-actual-diet-top-div #wphealthtracker-stats-inner-d3-2' );
					...
					d3TwoContainer.stop().animate({
						...
						duration: 1000,
						complete: function() {
							$( '.wphealthtracker-stats-actual-diet-top-div #wphealthtracker-stats-actual-inner-d3-2-2' ).append( statsHtmlTwo );
							$( '.wphealthtracker-stats-actual-diet-top-div #wphealthtracker-d3-chart-title-div-1-2' ).animate({'opacity': 1}, 2000 );
							d3TwoContainer.css({'height': 'auto'});
						}
					});

					// For animating the container's height, from 0 to auto
					d3ThreeContainer = $( '.wphealthtracker-stats-actual-diet-top-div #wphealthtracker-stats-inner-d3-3' );
					...
					d3ThreeContainer.stop().animate({
						...
						duration: 1000,
						complete: function() {
							$( '.wphealthtracker-stats-actual-diet-top-div #wphealthtracker-stats-actual-inner-d3-2-3' ).append( statsHtmlThree );
							$( '.wphealthtracker-stats-actual-diet-top-div #wphealthtracker-d3-chart-title-div-1-3' ).animate({'opacity': 1}, 2000 );
