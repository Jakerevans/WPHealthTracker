...
jQuery(document).ready(function($) {
  ...
  function wphealthtracker_jre_diet_get_row_of_data_html(key, loopNum, date, idNum, foodNum, data){
    ...
    switch(data[14]) {
      case wphealthtracker_php_variables.diettrans9:
          calOptions = '<option selected>'+wphealthtracker_php_variables.diettrans9+'</option><option>'+wphealthtracker_php_variables.diettrans10+'</option><option>'+wphealthtracker_php_variables.diettrans11+'</option>';
        break;
      case wphealthtracker_php_variables.diettrans10:
          calOptions = '<option>'+wphealthtracker_php_variables.diettrans9+'</option><option selected>'+wphealthtracker_php_variables.diettrans10+'</option><option>'+wphealthtracker_php_variables.diettrans11+'</option>';
        break;
      case wphealthtracker_php_variables.diettrans11:
          calOptions = '<option>'+wphealthtracker_php_variables.diettrans9+'</option><option>'+wphealthtracker_php_variables.diettrans10+'</option><option selected>'+wphealthtracker_php_variables.diettrans11+'</option>';
        break;
      default:
        calOptions = '<option>'+wphealthtracker_php_variables.diettrans9+'</option><option>'+wphealthtracker_php_variables.diettrans10+'</option><option>'+wphealthtracker_php_variables.diettrans11+'</option>';
    }
    ...
    switch(data[15]) {
      case wphealthtracker_php_variables.commontrans37:
          proteinOptions ='<option selected>'+wphealthtracker_php_variables.commontrans37+'</option><option>'+wphealthtracker_php_variables.diettrans13+'</option><option>'+wphealthtracker_php_variables.diettrans14+'</option><option>'+wphealthtracker_php_variables.diettrans15+'</option><option>'+wphealthtracker_php_variables.diettrans16+'</option><option>'+wphealthtracker_php_variables.diettrans17+'</option><option>'+wphealthtracker_php_variables.diettrans18+'</option><option>'+wphealthtracker_php_variables.diettrans19+'</option><option>'+wphealthtracker_php_variables.commontrans38+'</option>';
          break;
       case wphealthtracker_php_variables.diettrans13:
          proteinOptions ='<option>'+wphealthtracker_php_variables.commontrans37+'</option><option selected>'+wphealthtracker_php_variables.diettrans13+'</option><option>'+wphealthtracker_php_variables.diettrans14+'</option><option>'+wphealthtracker_php_variables.diettrans15+'</option><option>'+wphealthtracker_php_variables.diettrans16+'</option><option>'+wphealthtracker_php_variables.diettrans17+'</option><option>'+wphealthtracker_php_variables.diettrans18+'</option><option>'+wphealthtracker_php_variables.diettrans19+'</option><option>'+wphealthtracker_php_variables.commontrans38+'</option>';
          break;
        case wphealthtracker_php_variables.diettrans14:
          proteinOptions ='<option>'+wphealthtracker_php_variables.commontrans37+'</option><option>'+wphealthtracker_php_variables.diettrans13+'</option><option selected>'+wphealthtracker_php_variables.diettrans14+'</option><option >'+wphealthtracker_php_variables.diettrans15+'</option><option>'+wphealthtracker_php_variables.diettrans16+'</option><option>'+wphealthtracker_php_variables.diettrans17+'</option><option>'+wphealthtracker_php_variables.diettrans18+'</option><option>'+wphealthtracker_php_variables.diettrans19+'</option><option>'+wphealthtracker_php_variables.commontrans38+'</option>';
          break;
        case wphealthtracker_php_variables.diettrans15:
          proteinOptions ='<option>'+wphealthtracker_php_variables.commontrans37+'</option><option>'+wphealthtracker_php_variables.diettrans13+'</option><option>'+wphealthtracker_php_variables.diettrans14+'</option><option selected>'+wphealthtracker_php_variables.diettrans15+'</option><option>'+wphealthtracker_php_variables.diettrans16+'</option><option>'+wphealthtracker_php_variables.diettrans17+'</option><option>'+wphealthtracker_php_variables.diettrans18+'</option><option>'+wphealthtracker_php_variables.diettrans19+'</option><option>'+wphealthtracker_php_variables.commontrans38+'</option>';
          break;
        case wphealthtracker_php_variables.diettrans16:
          proteinOptions ='<option>'+wphealthtracker_php_variables.commontrans37+'</option><option>'+wphealthtracker_php_variables.diettrans13+'</option><option>'+wphealthtracker_php_variables.diettrans14+'</option><option>'+wphealthtracker_php_variables.diettrans15+'</option><option selected>'+wphealthtracker_php_variables.diettrans16+'</option><option>'+wphealthtracker_php_variables.diettrans17+'</option><option>'+wphealthtracker_php_variables.diettrans18+'</option><option>'+wphealthtracker_php_variables.diettrans19+'</option><option>'+wphealthtracker_php_variables.commontrans38+'</option>';
          break;
        case wphealthtracker_php_variables.diettrans17:
          proteinOptions ='<option>'+wphealthtracker_php_variables.commontrans37+'</option><option>'+wphealthtracker_php_variables.diettrans13+'</option><option>'+wphealthtracker_php_variables.diettrans14+'</option><option>'+wphealthtracker_php_variables.diettrans15+'</option><option>'+wphealthtracker_php_variables.diettrans16+'</option><option selected>'+wphealthtracker_php_variables.diettrans17+'</option><option>'+wphealthtracker_php_variables.diettrans18+'</option><option>'+wphealthtracker_php_variables.diettrans19+'</option><option>'+wphealthtracker_php_variables.commontrans38+'</option>';
          break;
        case wphealthtracker_php_variables.diettrans18:
          proteinOptions ='<option>'+wphealthtracker_php_variables.commontrans37+'</option><option>'+wphealthtracker_php_variables.diettrans13+'</option><option>'+wphealthtracker_php_variables.diettrans14+'</option><option>'+wphealthtracker_php_variables.diettrans15+'</option><option>'+wphealthtracker_php_variables.diettrans16+'</option><option>'+wphealthtracker_php_variables.diettrans17+'</option><option selected>'+wphealthtracker_php_variables.diettrans18+'</option><option>'+wphealthtracker_php_variables.diettrans19+'</option><option>'+wphealthtracker_php_variables.commontrans38+'</option>';
          break;
        case wphealthtracker_php_variables.diettrans19:
          proteinOptions ='<option>'+wphealthtracker_php_variables.commontrans37+'</option><option>'+wphealthtracker_php_variables.diettrans13+'</option><option>'+wphealthtracker_php_variables.diettrans14+'</option><option>'+wphealthtracker_php_variables.diettrans15+'</option><option>'+wphealthtracker_php_variables.diettrans16+'</option><option>'+wphealthtracker_php_variables.diettrans17+'</option><option>'+wphealthtracker_php_variables.diettrans18+'</option><option selected>'+wphealthtracker_php_variables.diettrans19+'</option><option>'+wphealthtracker_php_variables.commontrans38+'</option>';
          break;
        case wphealthtracker_php_variables.commontrans38:
          proteinOptions ='<option>'+wphealthtracker_php_variables.commontrans37+'</option><option>'+wphealthtracker_php_variables.diettrans13+'</option><option>'+wphealthtracker_php_variables.diettrans14+'</option><option>'+wphealthtracker_php_variables.diettrans15+'</option><option>'+wphealthtracker_php_variables.diettrans16+'</option><option>'+wphealthtracker_php_variables.diettrans17+'</option><option>'+wphealthtracker_php_variables.diettrans18+'</option><option>'+wphealthtracker_php_variables.diettrans19+'</option><option selected>'+wphealthtracker_php_variables.commontrans38+'</option>';
          break;
      default:
          proteinOptions ='<option>'+wphealthtracker_php_variables.commontrans37+'</option><option>'+wphealthtracker_php_variables.diettrans13+'</option><option>'+wphealthtracker_php_variables.diettrans14+'</option><option>'+wphealthtracker_php_variables.diettrans15+'</option><option>'+wphealthtracker_php_variables.diettrans16+'</option><option>'+wphealthtracker_php_variables.diettrans17+'</option><option>'+wphealthtracker_php_variables.diettrans18+'</option><option>'+wphealthtracker_php_variables.diettrans19+'</option><option>'+wphealthtracker_php_variables.commontrans38+'</option>';
    } 
  ...
  function wphealthtracker_jre_diet_clone_row_of_data(){
    $(document).on("click",".wphealthtracker-response-form-food-row-duplicate-div", function(event){
      ...
      //wphealthtracker_php_variables.diettrans20
  ...
  function wphealthtracker_jre_diet_selecteduser_diet_enter(){
    $(document).on("change","#wphealthtracker-user-dropdown-select-diet", function(event){
        ...
        var data = {
          ...
          'security': wphealthtracker_php_variables.dietnonce1,
          'wpuserid':wpuserid,
          'offset':offset
        };
  ...
  function wphealthtracker_jre_diet_selecteduser_diet_view(){
    $(document).on("change","#wphealthtracker-user-dropdown-select-diet", function(event){
        ...
        var data = {
          ...
          'security': wphealthtracker_php_variables.dietnonce2,
          'wpuserid':wpuserid,
          'offset':offset
        };
  ...
  function wphealthtracker_jre_diet_selecteduser_diet_filter_data(){
    $(document).on("click","#wphealthtracker-view-filter-button-diet-id", function(event){
      ...
      var data = {
        ...
        'security': wphealthtracker_php_variables.dietnonce4,
        'wpuserid':wpuserid,
        'filterval':filterVal
      };
    ...
    $(document).on("click",".wphealthtracker-save-stuff-button-diet", function(event){
      ...
      if(proceed){
        ...
        var data = {
            ...
            'security': wphealthtracker_php_variables.dietnonce3,
            'wpUserId':wpUserId,
            'firstName':firstName,
            'lastName':lastName,
            'humanDate':humanDate,
