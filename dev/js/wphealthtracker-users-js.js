...
jQuery( document ).ready( function( $ ) {
	...
	function wphealthtrackerCreateWpUser() {
		...
		$( '#wphealthtracker-save-new-users' ).click( function( e ) {
			...
			var phone = $( '#wphealthtracker-response-form-select-create-user-phone' ).val();
	...
	function wphealthrackerResetMissingDataAnim() {
		$( '#wphealthtracker-response-form-input-text-firstname, #wphealthtracker-response-form-input-text-email, #wphealthtracker-response-form-input-text-emailconfirm, #wphealthtracker-response-form-input-text-password, #wphealthtracker-response-form-input-text-passwordconfirm, #wphealthtracker-response-form-input-text-username' ).click( function( e ) {
