<?php
/**
 * Class WPHEALTHTRACKER_Exercise_Form - class-Exercise-form.php
 *
 * @author   Jake Evans
 * @category Display
...
if ( ! class_exists( 'WPHEALTHTRACKER_Exercise_Form', false ) ) :
	/**
	 * WPHEALTHTRACKER_Exercise_Form.
	 */
	class WPHEALTHTRACKER_Exercise_Form {
		...
		public function __construct() {
			...
			// Output final HTML.
			$this->output_create_exercise_form();
		...
		public function wphealthtracker_output_all_saved_users() {
			...
			if ( null !== $this->allusers ) {
				...
				$this->userstring = '<select autocomplete="off" class="wphealthtracker-user-dropdown-select" id="wphealthtracker-user-dropdown-select-exercise" data-select-tab="exercise"><option selected default disabled value="default">' . $this->trans->common_trans_16 . '</option>';
				...
				$this->userstring = '<img class="wphealthtracker-shocked-image" src="' . WPHEALTHTRACKER_ROOT_IMG_ICONS_URL . 'shocked.svg"><p class="wphealthtracker-user-dropdown-p">' . $this->trans->exercise_trans_1 . '<br/><a href="' . menu_page_url( 'WPHEALTHTRACKER-Options-users', false ) . '">' . $this->trans->exercise_trans_2 . '</a></p>';
			}
		}
		 ...
		 */
		public function output_create_exercise_form() {
					...
					<div id="wphealthtracker-choice-container">
						<div class="wphealthtracker-indiv-choice" id="wphealthtracker-indiv-choice-enter">
							<div class="wphealthtracker-expansion-div" id="wphealthtracker-expansion-div-enter">
								...
								<p class="wphealthtracker-indiv-choice-p">' . $this->trans->exercise_trans_1 . ' ' . $this->date . '</p>
							</div>
						...
						<div class="wphealthtracker-indiv-choice" id="wphealthtracker-indiv-choice-view">
							<div class="wphealthtracker-expansion-div" id="wphealthtracker-expansion-div-view">
								...
								<p class="wphealthtracker-indiv-choice-p">' . $this->trans->exercise_trans_2 . '</p>
							</div>
