<?php
/**
 * Class WPHEALTHTRACKER_Diet_Form - class-diet-form.php
 *
 * @author   Jake Evans
 * @category Display
...
if ( ! class_exists( 'WPHEALTHTRACKER_Diet_Form', false ) ) :
	/**
	 * WPHEALTHTRACKER_Diet_Form.
	 */
	class WPHEALTHTRACKER_Diet_Form {
		...
		public function __construct() {
			...
			$this->trans->diet_tab_trans_strings();
		...
		public function wphealthtracker_output_all_saved_users() {
			...
			if ( null !== $this->allusers ) {
				...
				$this->userstring = '<select autocomplete="off" class="wphealthtracker-user-dropdown-select" id="wphealthtracker-user-dropdown-select-diet" data-select-tab="diet"><option selected default disabled value="default">' . $this->trans->common_trans_16 . '</option>';
				...
				$this->userstring = '<img class="wphealthtracker-shocked-image" src="' . WPHEALTHTRACKER_ROOT_IMG_ICONS_URL . 'shocked.svg"><p class="wphealthtracker-user-dropdown-p">' . $this->trans->diet_trans_1 . '<br/><a href="' . menu_page_url( 'WPHEALTHTRACKER-Options-users', false ) . '">' . $this->trans->diet_trans_2 . '</a></p>';
			}
		}
		 ...
		 */
		public function output_create_diet_form() {
					...
					<div id="wphealthtracker-choice-container">
						<div class="wphealthtracker-indiv-choice" id="wphealthtracker-indiv-choice-enter">
							<div class="wphealthtracker-expansion-div" id="wphealthtracker-expansion-div-enter">
								...
								<p class="wphealthtracker-indiv-choice-p">' . $this->trans->diet_trans_25 . ' ' . $this->date . '</p>
							</div>
						...
						<div class="wphealthtracker-indiv-choice" id="wphealthtracker-indiv-choice-view">
							<div class="wphealthtracker-expansion-div" id="wphealthtracker-expansion-div-view">
								...
								<p class="wphealthtracker-indiv-choice-p">' . $this->trans->diet_trans_26 . '</p>
							</div>
