<?php
/**
 * Class WPHealthTracker_Diet_Stats_Tab - class-admin-stats-dietstats-tab-ui.php
 *
 * @author   Jake Evans
 * @category Admin
...
if ( ! class_exists( 'WPHealthTracker_Diet_Stats_Tab', false ) ) :
	/**
	 * WPHealthTracker_Diet_Stats_Tab.
	 */
	class WPHealthTracker_Diet_Stats_Tab {

		public function __construct() {
			require_once WPHEALTHTRACKER_CLASSES_UI_DISPLAY_DIR . 'class-ui-display-template.php';
			require_once WPHEALTHTRACKER_CLASSES_UI_DISPLAY_DIR . 'class-wphealthtracker-stats-diet-form.php';
			// Instantiate the class
			$this->template = new WPHEALTHTRACKER_UI_Display_Template();
			$this->form     = new WPHEALTHTRACKER_Stats_Diet_Form();
...
// Instantiate the class
$am = new WPHealthTracker_Diet_Stats_Tab();
